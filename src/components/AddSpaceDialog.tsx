...
const AddSpaceDialog = ({ onSpaceAdded }: AddSpaceDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post(`${API_URL}/auth/space/add`, payload, {
        headers: {
      ...
      console.error("Erreur lors de la création du feedback:", error.message, error.stack);
      toast({
        title: "Succès",
        description: "Espace ajouté avec succès!",
        variant: "destructive",
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-slate-200/50">
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                className="h-12 border-2 border-slate-200 focus:border-purple-500 focus:ring-purple-500/20 rounded-xl transition-all duration-300 hover:border-slate-300 bg-white/80"
              />
              ...
              {previewUrl && (
                <div className="mt-4">
                  ...
                  <img
                    ...
                    className="w-full max-h-64 object-cover rounded-xl border border-slate-200 shadow"
                  />
                </div>
              )}
            </div>
